from presto import parse_presto_labels
...
def test_parse_presto_labels__nested_labels():
    ...
    assert res["labels"] == [0, 0, 0, "message__medium", 0, 0, 0, "message__content", "message__content",
                             "message__content", "message__content", "message__content", "message__content",
                             "message__content", "message__content", 0]
    ...
    assert res["labels"] == ["modality", 0, 0, 0, "message__quantity__Number", "message__medium", 0,
                             "message__sender__person", 0]